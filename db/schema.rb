...
ActiveRecord::Schema.define(version: 20170102143343) do
  ...
  create_table "heartrates", force: :cascade do |t|
    ...
    t.datetime "updated_at",                null: false
    t.integer  "tweet_id",    limit: 4
    t.text     "heart_rates", limit: 65535
  end

  create_table "tweets", force: :cascade do |t|
    t.text     "text",               limit: 65535
    t.integer  "user_id",            limit: 4
    t.integer  "min_heartrate",      limit: 4
    t.integer  "max_heartrate",      limit: 4
    t.datetime "created_at",                       null: false
    t.datetime "updated_at",                       null: false
    t.boolean  "heartrate_flag"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.integer  "hr_cnt",                 limit: 4
    t.integer  "hr_mean",                limit: 4
  end

  add_index "users", ["email"], name: "index_users_on_email", unique: true, using: :btree
  add_index "users", ["reset_password_token"], name: "index_users_on_reset_password_token", unique: true, using: :btree

  create_table "usertokens", force: :cascade do |t|
    t.integer  "user_id",       limit: 4
