...
#  provider :fitbit_oauth2, "227YDT", "d2c2fdd07deb12a78f2b6cbed91dbbcf", response_type: 'code', scope: 'profile heartrate', redirect_uri: "http://localhost:3000/auth/fitbit_oauth2/callback", expires_in: '2592000'
  ...
  # heroku update
  provider :fitbit_oauth2, "227YDT", "d2c2fdd07deb12a78f2b6cbed91dbbcf", response_type: 'code', scope: 'profile heartrate', redirect_uri: "https://heart-beat-tweet.herokuapp.com/auth/fitbit_oauth2/callback", expires_in: "259200"
